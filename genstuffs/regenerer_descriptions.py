...
def extract_keywords(csv_desc: str) -> tuple:
    ...
    abstract_words = {
        ...
        "petite", "petit", "grande", "grand", "vieux", "vieille",
        "montant", "descendant", "descendante", "grimpant", "grimpe",
        "fermé", "fermée", "fermés", "fermées", "bloqué", "bloquée", "bloqués", "bloquées",
        "sortant", "sortante", "sortis", "sorties",
        "dessiné", "dessinée", "dessinés", "dessinées",
        ...
        "formant", "plaçant", "placé", "placée", "placés", "placées",
        "glacé", "glacée", "glacés", "glacées",
        "brisé", "brisée", "brisés", "brisées",
        "pourri", "pourrie", "pourris", "pourries",
        "beaucoup", "jamais", "pourraient", "peuvent",
        "chose", "choses", "quelque", "quelques",
        "d�but", "fin", "certain", "certains", "certaine", "certaines",
        "séparé", "séparée", "séparés", "séparées",
        "numéro", "problème", "pourquoi",
        "donjon", "latrines", "latrine",
        "cheminée", "cheminées", "foyer", "foyers", "âtres",
        "piège", "pièges",
        "après", "passé", "avant", "pendant",
        "fente", "fentes",
        "fontaine",
        "ossuaire",
        "glacé", "glacée", "glacés", "glacées",
        "glacée",
        "armillaire", "tlescope", "télescope",
        "mandala",
        "créature", "cr�ature",
        "lit", "lits",
        "chaise", "chaises",
...
SYNONYMS = {
    ...
    "lit": ["couche", "grabat", "lits", "couches", "grabats", "hamac"],
    "chaise": ["tabouret", "chaises", "tabourets", "banc", "bancs"],
    "piège": ["trap", "snare", "pièges", "trappes", "machination", "embûche"],
    "cage": ["cages", "celle", "cellule"],
    "donjon": ["dungeon", "forteresse", "château"],
    "latrine": ["latrines", "toilette", "toilettes", "sanitize"],
    "glacé": ["gelé", "glacial", "gel", "givré"],
    "glacée": ["gelée", "glaciale", "gel"],
    "colonnes": ["piliers", "colonnade", "colonnes"],
    "cheminées": ["foyers", "âtres", "cheminées"],
    "conseil": ["réunion", "délibération", "assemblée"],
    "piège": ["trap", "snare", "pièges", "trappes", "embûche"],
    "lit": ["couche", "grabat", "lits", "couches", "grabats", "hamac"],
    "chaise": ["tabouret", "chaises", "tabourets", "banc", "bancs"],
    "chaises": ["tabourets", "bancs", "chaises"],
    "table": ["pupitre", "tables"],
    "fente": ["fentes", "ouverture", "fissure"],
    "donjon": ["dungeon", "forteresse", "château", "donjons"],
    "latrines": ["toilette", "toilettes", "sanitaires", "latrines"],
}
